...
Para obter uma visão geral do próximo roteiro do Principal Componente, consulte o [projeto wiki no github](https://github.com/adobe/aem-core-wcm-components/wiki/home).
...
Para obter mais informações sobre o uso dessas ferramentas, [consulte sua documentação](http://opensource.adobe.com/aem-modernize-tools/).
