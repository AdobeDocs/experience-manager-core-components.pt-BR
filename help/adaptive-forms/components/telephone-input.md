...
A guia é usada para definir e gerenciar estilos de CSS de um componente. O componente principal de entrada de telefone de formulários adaptáveis é compatível com o [sistema de estilos](/help/get-started/authoring.md#component-styling) do AEM.
...
![Guia Formatar](/help/adaptive-forms/assets/telephoneinput_format.png)
