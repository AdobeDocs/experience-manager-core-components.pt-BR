...
A guia é usada para definir e gerenciar estilos de CSS de um componente. O Componente principal do botão Adaptive Forms Submit suporta o AEM [Sistema de estilos](/help/get-started/authoring.md#component-styling).
