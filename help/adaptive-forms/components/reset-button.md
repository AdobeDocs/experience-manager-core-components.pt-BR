...
A guia é usada para definir e gerenciar estilos de CSS de um componente. O Componente principal do botão Redefinir de Formulários adaptáveis suporta o [Sistema de estilos](/help/get-started/authoring.md#component-styling) do AEM.
