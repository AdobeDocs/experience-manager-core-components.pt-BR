...
### Guia Repetir painel {#repeat-panel}

![guia repetir](/help/adaptive-forms/assets/repeat-panel.png)

Você pode usar as opções de repetibilidade para duplicar o contêiner do painel e seus componentes secundários, definir uma contagem de repetição mínima e máxima e facilitar a replicação de seções semelhantes em um formulário. Ao interagir com o componente de contêiner do painel e acessar suas configurações, as seguintes opções são apresentadas:
...
* **Mínimo de repetições**: estabelece o número mínimo de vezes que o contêiner do painel pode ser repetido. Um valor zero indica que o painel Assistente não é repetido; o valor padrão é zero.
* **Máximo de repetições**: define o número máximo de vezes que o contêiner do painel pode ser repetido. Por padrão, esse valor é ilimitado.

Para gerenciar com eficácia as seções repetíveis no contêiner do painel, siga as etapas fornecidas no [Criação de formulários com seções repetíveis](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-core-components/create-an-adaptive-form-on-forms-cs/create-forms-repeatable-sections.html) artigo.
