...
>Para obter detalhes sobre a versão atual do Componente de pesquisa rápida, consulte o [Componente de pesquisa rápida](/help/components/quick-search.md) documento.
