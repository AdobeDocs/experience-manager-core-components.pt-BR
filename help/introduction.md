...
* [Componentes principais adaptáveis do Forms](/help/adaptive-forms/introduction.md) - Ao usar os Componentes principais adaptáveis do Forms no Adobe Experience Manager, você pode criar experiências de inscrição atraentes.
