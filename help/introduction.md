...
* [Pesquisa com IA de conteúdo](components/ai-search.md)
...
* [Lista de fragmentos de conteúdo](components/content-fragment-list.md)
...
|---|---|---|---|---|---|
| [2.32.8](https://github.com/adobe/aem-core-wcm-components/releases/tag/core.wcm.components.reactor-2.32.8) | Contínuo | 6.5 LTS GA | 6.5.21.0+ | 8, 11, 17, 21 | 3.3.9+ |
...
* [Componentes principais dos formulários adaptáveis](/help/adaptive-forms/introduction.md): usando os componentes principais dos formulários adaptáveis do Adobe Experience Manager, é possível criar experiências de inscrição atraentes.
