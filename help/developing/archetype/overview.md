...
>[!TIP]
>
>O Arquétipo de projeto AEM mais recente [pode ser encontrado no GitHub](https://github.com/adobe/aem-project-archetype).
...
|---------|---------|---------|---------|---------|---------|
| [26º](https://github.com/adobe/aem-project-archetype/releases/tag/aem-project-archetype-26) | Contínuo | 6.5.5.0+ | 6.4.8.1+ | 8, 11 | 3.3.9+ |
