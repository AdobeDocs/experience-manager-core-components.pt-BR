...
| `includeFormscommunications` | `n` | Inclui [Componentes principais do Forms](https://github.com/adobe/aem-core-forms-components) dependências, modelos, modelos de dados de formulário, temas e gera artefatos correspondentes para programas de Comunicações da Forms. |
| `includeFormsenrollment` | `n` | Inclui [Componentes principais do Forms](https://github.com/adobe/aem-core-forms-components) dependências, modelos, modelos de dados de formulário, temas e gera artefatos correspondentes para programas de Inscrição no Forms. |

## Requisitos do sistema {#requirements}

| Arquétipo | AEM as a Cloud Service | AEM 6.5 | Java SE | Maven |
|---------|---------|---------|---------|---------|
| [32º](https://github.com/adobe/aem-project-archetype/releases/tag/aem-project-archetype-32) | Contínuo | 6.5.7.0+ | 8, 11 | 3.3.9+ |
