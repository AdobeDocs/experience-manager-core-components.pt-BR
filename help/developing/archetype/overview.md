...
| `sdkFormsVersion` | `latest` | When `aemVersion=cloud` e um de `includeFormsenrollment=y` ou `includeFormscommunications=y`, uma versão do SDK do Forms pode ser especificada (por exemplo, `2020.12.17.02`). |
...
| `includeFormsheadless` | `n` | Inclui [Componentes principais do Forms](https://github.com/adobe/aem-core-forms-components) dependências, `ui.frontend.react.forms.af`e artefatos sem cabeça. |

## Requisitos do sistema {#requirements}

| Arquétipo | AEM as a Cloud Service | AEM 6.5 | Java SE | Maven |
|---------|---------|---------|---------|---------|
| [39](https://github.com/adobe/aem-project-archetype/releases/tag/aem-project-archetype-39) | Contínuo | 6.5.7.0+ | 8, 11 | 3.3.9+ |
