...
* Componente da página com base no componente principal da página do [AEM](/help/components/page.md)
* Exemplos de componentes de conteúdo implementados com o padrão de proxy recomendado e um exemplo de componente personalizado do mundo de ajuda, todos baseados nos Componentes [principais do](/help/introduction.md)AEM.
...
* Adobe Experience Manager 6.3.3.0 ou superior (6.4.2 ou superior ao gerar um projeto com as opções de criação de front-end Angular ou React) ou [AEM como um serviço de nuvem](https://docs.adobe.com/content/help/en/experience-manager-cloud-service/landing/home.html)
...
| `includeErrorHandler` | n | Incluir uma página de resposta 404 personalizada |
| `frontendModule` | nenhum | Incluir um módulo de front-end dedicado (um de `none`, [`general`](uifrontend.md), [`angular`](uifrontend-angular.md), [`react`](uifrontend-react.md)) |
| `singleCountry` | y | Criar estrutura de idioma mestre em conteúdo de exemplo |
| `includeDispatcherConfig` | n | Define se uma configuração de despachante é gerada para o projeto <br> Definido como [`cloud`](https://github.com/adobe/aem-project-archetype/tree/master/src/main/archetype/dispatcher.cloud) ao criar um projeto para o [AEM como um Serviço](https://docs.adobe.com/content/help/en/experience-manager-cloud-service/landing/home.html) em nuvem Definido como <br> [`ams`](https://github.com/adobe/aem-project-archetype/tree/master/src/main/archetype/dispatcher.ams) ao criar um projeto para os Serviços gerenciados da Adobe |
