...
>[!NOTE]
>
>É recomendável atualizar seu projeto Maven para fazer referência à versão mais recente do plug-in encontrada no [Repositório central Maven.](https://repo1.maven.org/maven2/com/adobe/aem/aemanalyser-maven-plugin/)
