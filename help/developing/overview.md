...
* Recursos ricos em recursos
   * [Opções](/help/get-started/authoring.md) de configuração flexíveis para acomodar muitos casos de uso
   * [Recursos](/help/get-started/authoring.md#pre-configuring-core-components) pré-configuráveis para definir quais recursos estão disponíveis para autores de páginas
* Entrega contínua
...
Consulte a página de documentação [Uso dos componentes](/help/get-started/using.md) principais para saber como começar a usá-los no seu projeto.
...
>[!NOTE]
>
>Em ambientes de produção local, sempre execute o Início rápido no `nosamplecontent` modo de execução. Para usar os Componentes principais no `nosamplecontent` modo de execução, siga as instruções da página de documentação [Uso dos componentes](/help/get-started/using.md) principais.
